package com.fhacktory.plugins.inputs.audio.speech_recognition.google_speech;

import com.fhacktory.plugins.inputs.audio.speech_recognition.SpeechRecognizer;
import com.fhacktory.plugins.inputs.audio.speech_recognition.google_speech.dtos.requests.GoogleSpeechAudioRequestDto;
import com.fhacktory.plugins.inputs.audio.speech_recognition.google_speech.dtos.requests.GoogleSpeechConfigRequestDto;
import com.fhacktory.plugins.inputs.audio.speech_recognition.google_speech.dtos.requests.GoogleSpeechRequestDto;
import com.fhacktory.plugins.inputs.audio.speech_recognition.google_speech.dtos.responses.GoogleSpeechAlternativeResponseDto;
import com.fhacktory.plugins.inputs.audio.speech_recognition.google_speech.dtos.responses.GoogleSpeechResponseDto;
import com.fhacktory.plugins.inputs.audio.speech_recognition.google_speech.endpoints.GoogleSpeechEndpoint;
